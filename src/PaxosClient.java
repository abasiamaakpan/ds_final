...
public class PaxosClient {
 ...
 private static String filepath;
  ...
  /**
   * A function that creates a 'ClientFiles' directory in the current directory. This directory is the
   * root directory for our distributed file system.
   */
...
//    String s =  readLocalFile("test");
//    System.out.println(s);
//    writeFile("test","write something here!");
